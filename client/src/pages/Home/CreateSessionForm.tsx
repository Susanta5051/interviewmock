...
const CreateSessionForm = () => {
    ...
    try{
        ...
        const response = await axios.post(backendUrl + API_PATHS.SESSION.CREATE, { 
            ...formData, 
    ...
    return <div className="w-[90vw] md:w-[35vw] p-7 flex flex-col justify-center">
        ...
        <Input
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleChange("topicsToFocus", e.target.value)}
